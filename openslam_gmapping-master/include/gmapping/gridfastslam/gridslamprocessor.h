  ...
  */
   ...
   */
    ...
    */
    ...
    bool processScantest(const std::vector<RangeReading> & reading_, int adaptParticles=0);//test
  ...
  private:
    ...
    inline void scanMatchtest(std::vector<double *> &plainReading_); // test
    ...
    inline bool resampletest(std::vector<double*> & plainReading_, int adaptParticles,
                         std::vector<RangeReading*> & reading_);  // test
